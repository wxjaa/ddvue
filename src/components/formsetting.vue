<template>
    <div class="wf-form wf-formsettings">
        ...
        <div class="wf-field wf-setting-icon">
            ...
            <div class="fieldblock">
                <div class="wf-iconselect">
                    <label @click="selectIcon" :data-index="index" v-for="(item,index) in icons" class="iconitem" v-bind:class="index==selected?'seltected':''">
